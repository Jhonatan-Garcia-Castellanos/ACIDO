...
<head>
    ...
    <link rel="stylesheet" href="/ACIDO/BACKPHP_TEST/public/styles.css">
</head>
...
<body>
    <div class="container">
        ...
        <div class="right-panel">
            <div class="form-box">
                <img src="/ACIDO/BACKPHP_TEST/public/img/acidoo.png" alt="ACIDO Colombia" class="logo">
                ...
                <form action="/ACIDO/BACKPHP_TEST/controller/change_password.php" method="POST">
                ...
                <div class="footer-links">
                    <a href="/ACIDO/BACKPHP_TEST/index.php?action=login">¿RECORDAS TE TU CLAVE? INICIA SESIÓN</a>
                </div>
            </div>
        </div>
    </div>
